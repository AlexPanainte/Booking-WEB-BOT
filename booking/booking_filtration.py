#This file will be resposible to interact with our site
...
class BookingFiltration:
    ...
    def apply_star_rating(self , *star_values):
        ...
        star_child_elemnts = self.driver.find_elements(By.CSS_SELECTOR , '*')

        for star_value in star_values:
            for star_element in star_child_elemnts:
